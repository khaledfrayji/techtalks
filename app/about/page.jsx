      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
        ...
        <div ref={heroRef} className="text-center mb-20 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <a href='https://chat.whatsapp.com/Lgi0Eubj6Jw9682LTKl1KA' className="flex items-center gap-2">
        ...
        <div ref={el => sectionsRef.current[4] = el} className="mb-20">
          <div className="bg-gradient-to-r from-purple-900/30 to-cyan-900/30 border border-purple-500/30 rounded-xl p-12 text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <a href='/ambassador' className="flex items-center gap-2">
...
export default TechTalksAboutPage;